...
def includeme(config):
    ...
    config.add_route('api_collection', '/api/{scope}/{endpoint}.json')
    config.add_route('api_item', '/api/{scope}/{endpoint}/{id}.json')
    config.add_route('api_action', '/api/{scope}/{endpoint}/{id}')
